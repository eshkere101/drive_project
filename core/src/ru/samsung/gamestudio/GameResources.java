...
public class GameResources {
    ...
    public static final String CAR_IMG_PATH = "textures/car.png";
    public static final String RED_CAR_IMG_PATH = "textures/redcar.png";

    // Sounds and music for audio

    public static final String BACKGROUND_MUSIC_PATH = "sounds/background_music.mp3";
    public static final String DESTROY_SOUND_PATH = "sounds/beep.mp3";
